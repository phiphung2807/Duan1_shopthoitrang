...
function hoadon_insert($ma_kh, $tong_tien, $ngay_mua, $ghi_chu, $giao_hang, $thanh_toan)
{
    $sql = "INSERT INTO hoadon( ma_kh, tong_tien, ngay_mua, ghi_chu,giao_hang, thanh_toan)  VALUES(?,?,?,?,?,?)";
    pdo_execute($sql, $ma_kh, $tong_tien, $ngay_mua, $ghi_chu, $giao_hang, $thanh_toan);
}
...
function hoadon_update($ma_hd,$ma_kh, $tong_tien, $ngay_mua, $ghi_chu, $giao_hang, $thanh_toan)
{
    $sql = "UPDATE hoadon SET ma_kh=?, tong_tien=?, ngay_mua=?, giao_hang=?, thanh_toan=?, ghi_chu=? WHERE ma_hd=?";
    pdo_execute($sql, $ma_kh, $tong_tien, $ngay_mua, $ghi_chu, $giao_hang, $thanh_toan, $ma_hd);
}
