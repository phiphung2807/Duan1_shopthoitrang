    ...
    <div class="wrapper">
        <div id="header">
            ...
            <ul class="menu">
                ...
                <li><a href="<?= $ADMIN_URL ?>/danhmuc/index.php?btn_list"><i class="fa-solid fa-list"></i> Danh mục</a></li>
                <li><a href="<?= $ADMIN_URL ?>/products/index.php?btn_list"><i class="fa-solid fa-table-list"></i> Sản phẩm</a></li>
                <li><a href="<?= $ADMIN_URL ?>/user/"><i class="fa-solid fa-users"></i> Khách hàng</a></li>
                <li><a href="<?= $ADMIN_URL ?>/comment/index.php?btn_list"><i class="fa-solid fa-comment"></i> Bình luận</a></li>
                <li><a href="<?= $ADMIN_URL ?>/cart/index.php?btn_list"><i class="fa-solid fa-cart-shopping"></i> Đơn hàng</a></li>
